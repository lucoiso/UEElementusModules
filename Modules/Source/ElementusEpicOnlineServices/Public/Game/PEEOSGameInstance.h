...
#include "PEEOSGameInstance.generated.h"
...
class ELEMENTUSEPICONLINESERVICES_API UPEEOSGameInstance : public UGameInstance
{
    GENERATED_BODY()

public:
    explicit UPEEOSGameInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
